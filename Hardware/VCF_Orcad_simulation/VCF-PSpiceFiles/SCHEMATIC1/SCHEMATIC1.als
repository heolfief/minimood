...
R_R18           R18(1=0 2=OUTPUTVCF ) CN @VCF.SCHEMATIC1(sch_1):INS6681@ANALOG.R.Normal(chips)
...
X_U4            U4(IN+=N10926 IN-=N11078 V+=VCC V-=0 OUT=OUTPUT ) CN
...
R_R23           R23(1=N11078 2=OUTPUT ) CN @VCF.SCHEMATIC1(sch_1):INS11022@ANALOG.R.Normal(chips)
R_R24           R24(1=OUTPUTVCF 2=N11078 ) CN @VCF.SCHEMATIC1(sch_1):INS11058@ANALOG.R.Normal(chips)
V_V8            V8(+=INPUT -=0 ) CN @VCF.SCHEMATIC1(sch_1):INS11356@SOURCE.VSIN.Normal(chips)
_    _(DAC_OUT=DAC_OUT)
_    _(Input=INPUT)
_    _(Output=OUTPUT)
